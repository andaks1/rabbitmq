# Домашнее задание к занятию  «Очереди RabbitMQ» - Андрей Аксенов
...
![rabbit_web](img/zadanie1/01_01.png)
...
1. Скриншот наполнения очереди скриптом 'producer.py':
![producer](img/zadanie2/02_01.png)

2. Скриншот разбора очереди скриптом 'consumer.py':
![consumer](img/zadanie2/02_02.png)
...
1. Скриншот кластера из веб-интерфейса:
![cluster](img/zadanie3/03_01.png)
...
Скриншот разбора очереди скриптом:
![received](img/zadanie3/03_05.png)
